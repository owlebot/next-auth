...
export async function handleLoginOrRegister(sessionToken, _profile, _account, options) {
    ...
    const { createUser, updateUser, getUser, getUserByAccount, getUserByEmail, linkAccount, linkAccountOverride, createSession, getSessionAndUser, deleteSession, } = adapter;
    let session = null;
    let user = null;
    let isNewUser = false;
